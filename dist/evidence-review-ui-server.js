...
export async function prepareProofLayerUiLaunch(options, dependencies = {}) {
    const host = options.host ?? DEFAULT_HOST;
    assertLoopbackHost(host);
    const requestedPort = options.port ?? DEFAULT_PORT;
    assertPort(requestedPort);
...
export async function launchProofLayerUi(options, dependencies = {}) {
...
export function formatProofLayerUiLaunch(prepared) {
    return [
