import { z } from "zod";
import { JobEvidenceLinkConfidenceSchema, JobEvidenceStrengthSchema, JobRequirementInputTypeSchema, JobRequirementLinkProvenanceSchema, } from "./job-evidence-map-schemas.js";
...
export const JobRequirementCoverageSchema = z.object({
    ...
    const countedLinks = value.linkCounts.direct +
    ...
    if (value.mappedLinkIds.length === 0 &&
