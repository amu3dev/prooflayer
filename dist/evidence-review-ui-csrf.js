...
import { EVIDENCE_REVIEW_SUBMIT_ACTION, productWorkflowActionAllowed, productWorkflowActionRequiresTarget, } from "./prooflayer-ui-request-scope.js";
...
export function evidenceReviewUiClaimCsrfToken(sessionSecret, batchId, claimId) {
...
export function proofLayerUiActionCsrfToken(sessionSecret, claims) {
    assertSessionSecret(sessionSecret);
...
export function evidenceReviewUiCsrfTokenMatches(actual, expected) {
