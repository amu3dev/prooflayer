...
import { extractEvidenceFromSource, generateClaimsFromEvidence, isClaimCandidate } from "../operations.js";
...
describe("Markdown resume parsing", () => {
    ...
    it("keeps repeated consulting periods when title and company are the same", () => {
        const repeatedRoleResume = resume.replace("## Enterprise Engineering Foundation", `### Example Platform Company
**Technical Product Manager**
...
## Enterprise Engineering Foundation`);
    ...
    it("requires multi-source or manual approval for broad summaries", () => {
        const publicSource = { ...source, id: "src_public_1", visibility: "public" };
        const secondPublicSource = { ...source, id: "src_public_2", visibility: "public" };
