...
import { continueRoleWorkflow, formatRoleWorkflowStatus, getGeneratedRoleUnderstandingStatus, inspectRoleWorkflow, replayGeneratedRoleUnderstanding, runRoleWorkflow, showGeneratedRoleUnderstanding, ROLE_UNDERSTANDING_PROMPT_ID, } from "../role-workflow.js";
...
function expectation(kind, statement, capabilityTags) {
    return {
        kind,
        statement,
        necessity: "required",
