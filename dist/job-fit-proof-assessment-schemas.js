import { z } from "zod";
import { JobCoverageEvidenceMapProvenanceSchema, JobRequirementCoverageStateSchema, JobRequirementEvidenceQualitySchema, } from "./job-coverage-schemas.js";
import { JobRequirementCategorySchema, JobRequirementNecessitySchema, } from "./job-requirement-schemas.js";
import { JobRequirementInputTypeSchema, JobRequirementLinkProvenanceSchema, } from "./job-evidence-map-schemas.js";
...
export const JobRequirementFitProofAssessmentSchema = z.object({
    ...
    if (value.assessmentState === "strength" &&
    ...
    if (value.assessmentState === "contradiction" &&
...
export const JobFitProofAssessmentCompletenessSchema = z.object({
    ...
    if (value.readyForDownstreamPlanning &&
...
export const JobFitProofAssessmentSchema = z.object({
    ...
    const requirementIds = value.requirementAssessments.map((entry) => entry.requirementId);
