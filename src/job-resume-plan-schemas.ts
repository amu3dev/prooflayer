import { z } from "zod";
import {
  JobAssessmentMaterialitySchema,
  JobAssessmentProofStrengthSchema,
  JobOverallAssessmentStateSchema,
  JobRequirementAssessmentStateSchema,
} from "./job-fit-proof-assessment-schemas.js";
import {
  JobCandidateEvidenceProvenanceSchema,
  JobEvidenceRelationshipSchema,
...
export const JobEvidenceSelectionDecisionSchema =
  JobRequirementEmphasisDecisionSchema;
...
export const JobRequirementEmphasisSchema = z.object({
  ...
  const selected = ["primary", "secondary", "supporting"].includes(
    value.decision,
  );
...
export const JobResumeContentPlanSchema = z.object({
  ...
  const requirementIds = value.requirementEmphasis.map(
  ...
  if (
    value.positioning.state === "insufficient-proof" ||
    ...
    if (value.completeness.usableForDrafting) {
      context.addIssue({
        code: z.ZodIssueCode.custom,
        message:
          "Insufficient or indeterminate positioning is not usable for drafting",
...
export type JobResumePositioningState = z.infer<
  typeof JobResumePositioningStateSchema
>;
export type JobRequirementEmphasisDecision = z.infer<
  typeof JobRequirementEmphasisDecisionSchema
>;
...
export type JobRequirementEmphasis = z.infer<
  typeof JobRequirementEmphasisSchema
>;
export type JobResumeEvidenceSelection = z.infer<
  typeof JobResumeEvidenceSelectionSchema
>;
export type JobResumeClaimBoundary = z.infer<
  typeof JobResumeClaimBoundarySchema
>;
...
export type JobResumeSectionPlan = z.infer<
  typeof JobResumeSectionPlanSchema
>;
export type JobResumeContentExclusion = z.infer<
  typeof JobResumeContentExclusionSchema
>;
export type JobResumePlanningRisk = z.infer<
  typeof JobResumePlanningRiskSchema
>;
export type JobResumePlanningWarning = z.infer<
  typeof JobResumePlanningWarningSchema
>;
export type JobResumePlanningAmbiguity = z.infer<
  typeof JobResumePlanningAmbiguitySchema
>;
export type JobResumeContentPlan = z.infer<
  typeof JobResumeContentPlanSchema
>;
export type JobResumeContentPlanManifest = z.infer<
  typeof JobResumeContentPlanManifestSchema
>;
