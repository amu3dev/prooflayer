...
export const EVIDENCE_REVIEW_BATCH_SCHEMA_VERSION = 1 as const;
...
export const EvidenceReviewBatchSchema = z.object({
  ...
  warning: z.literal(
    "Batch priority organizes human review only; it does not establish factual support, approval, eligibility, or fit.",
  ),
