...
export const EVIDENCE_CLAIM_REVIEW_SCHEMA_VERSION = 1 as const;
export const EVIDENCE_CLAIM_REVIEW_POLICY_NAME =
  "evidence-claim-review-policy";
...
export type EvidenceClaimReviewSnapshotProjection = z.infer<
  typeof EvidenceClaimReviewSnapshotProjectionSchema
>;
