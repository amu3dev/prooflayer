...
export const RoleResumeDraftItemProvenanceSchema = z.object({
  ...
  compositionSlotId: z.string().min(1),
...
export const RoleResumeDraftScaffoldSectionSchema = z.object({
  ...
  compositionSlotIds: z.array(z.string().min(1)),
  requiredCompositionSlotIds: z.array(z.string().min(1)),
...
export const RoleResumeDraftScaffoldProvenanceSchema = z.object({
  ...
  compositionSha256: Sha256Schema,
  compositionManifestSha256: Sha256Schema,
...
export const RoleResumeDraftScaffoldSchema = z.object({
  ...
  composition: PlanDependencySchema,
  draftingPolicy: z.object({ name: z.string().min(1), version: z.string().min(1) }).strict(),
...
export const RoleResumeDraftCompletenessSchema = z.object({
  ...
  chronologyComplete: z.boolean(),
  selectedEvidenceAccounted: z.boolean(),
  experienceEntryCount: z.number().int().nonnegative(),
  projectEntryCount: z.number().int().nonnegative(),
  skillCount: z.number().int().nonnegative(),
  evidenceBackedBulletCount: z.number().int().nonnegative(),
